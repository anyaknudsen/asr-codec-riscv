...
/*
 * TODO(codec_a): implement the encoder here.
 *
 ...
 *   4. Iterate over pcm.samples in CODEC_A_FRAME_SAMPLES-sample frames
...
int encode_file(const char *input_path, const char *output_path)
{
    ...
    io_report_error("codec_a: encode_file() is not implemented yet");
    return -1;
}
