...
help:
	...
	@echo "  run-native    run native encode+decode, write results/native/"
	@echo "  run-spike     run Spike encode+decode, write results/spike/"
	@echo "  run-gem5      run gem5 SE-mode encode+decode, write results/gem5/"
